...
export function Footer() {
  ...
  return (
    <footer className="bg-dark-brown text-[#FFFAF7] py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-[#FFFAF7]/80 mb-4">Subscribe to our newsletter for design inspiration and project updates</p>
            <form onSubmit={handleNewsletterSubmit} className="space-y-3">
              <Input 
                ...
                className="bg-[#FFFAF7]/10 border-[#FFFAF7]/20 text-[#FFFAF7] placeholder-[#FFFAF7]/60 focus:ring-warm-gold focus:border-transparent"
              />
              <Button 
                type="submit" 
          ...
          <div>
            ...
            <div className="space-y-3 text-[#FFFAF7]/80">
          ...
          <div>
            ...
            <ul className="space-y-2 text-[#FFFAF7]/80">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              <a href="#" className="w-10 h-10 bg-[#FFFAF7]/10 rounded-lg flex items-center justify-center hover:bg-warm-gold hover:text-dark-brown transition-all">
            ...
            <ul className="space-y-2 text-[#FFFAF7]/80 text-sm">
        ...
        <div className="border-t border-[#FFFAF7]/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-[#FFFAF7]/60 text-sm mb-4 md:mb-0">
              © 2024 Nils Holger Interior Design. All rights reserved.
            </p>
            <p className="text-[#FFFAF7]/60 text-sm">
