    ...
    <div className="min-h-screen bg-off-white" style={{ margin: 0, padding: 0 }}>
      ...
      <section className="pt-32 pb-16 bg-[#FAF7F2]">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-[#251104] mb-6">
            Career & Workshop
          </h1>
      ...
      <section className="py-12 bg-[#FAF7F2] text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="mb-4">
            <span className="inline-block bg-[#FBD44C] text-[#251104] px-6 py-2 rounded-full text-sm font-semibold">
              Launching Soon
            </span>
          </div>
          <button 
            onClick={() => scrollToSection('contact')}
            className="bg-[#FBD44C] text-[#251104] px-8 py-3 rounded-lg font-medium hover:bg-[#FBD44C]/90 transition-all duration-300 transform hover:scale-105"
      ...
      <section id="career" className="career-section py-12 bg-off-white">
        <div className="max-w-6xl mx-auto px-4">
          {/* Section Title */}
          <div className="mb-12">
            <h1 className="font-serif text-4xl md:text-5xl font-bold text-[#251104] mb-6 text-center">Career & Internship</h1>
          ...
          <div className="career-card bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            <h3 className="font-serif text-xl font-bold text-[#251104] mb-4 tracking-wide">Student Collaboration</h3>
            ...
            <div className="career-grid grid grid-cols-1 md:grid-cols-2 gap-[2px] bg-[#F9F9F9] p-[2px]">
              <div className="career-card text-left bg-white p-8 h-[400px] flex flex-col justify-center">
                <h4 className="font-serif text-lg font-bold text-[#251104] mb-3 tracking-wide">What We Offer</h4>
              ...
              <div className="career-card text-left bg-white p-8 h-[400px] flex flex-col justify-center">
                <h4 className="font-serif text-lg font-bold text-[#251104] mb-3 tracking-wide">Areas of Focus</h4>
                <ul className="text-[#5B401C] space-y-2">
                  <li className="flex items-start">
                    <div className="w-1.5 h-1.5 bg-[#FBD44C] rounded-full mr-3 flex-shrink-0 mt-2"></div>
      ...
      <section id="contact" className="py-16 bg-[#FAF7F2]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-[#251104] mb-6">
          ...
          <button 
            ...
            className="bg-[#FBD44C] text-[#251104] px-8 py-4 rounded-lg font-semibold text-lg hover:bg-[#FBD44C]/90 transition-all duration-300 transform hover:scale-105"
