...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-off-white" style={{ margin: 0, padding: 0 }}>
      ...
      {/* Vår Process Section */}
      <section className="w-full bg-[#251104] py-16 md:py-24">
              ...
              >
                ...
                {openProcessStep === step.number && (
                  <div className="absolute top-0 left-0 right-0 bg-[#FBD44C] p-6 rounded-lg text-left z-10 min-h-full flex flex-col justify-center">
                    <h4 className="font-serif font-bold text-lg text-[#251104] mb-3">
                      {step.subtitle}
                    </h4>
                    <p className="text-[#251104] text-sm md:text-base leading-relaxed">
                      {step.description}
                    </p>
                  </div>
                )}
