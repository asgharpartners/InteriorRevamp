      ...
      <section className="w-full bg-[#FAF7F2] pt-32 md:pt-40 lg:pt-48 pb-16 md:pb-24">
        <div className="max-w-6xl mx-auto px-8 md:px-12 text-center">
          ...
          <p className="text-xl md:text-2xl text-[#5B401C] max-w-4xl mx-auto leading-relaxed">
            Upptäck vårt omfattande portfolio av inrednings- och byggprojekt. Från hotell och restauranger till kontor och bostäder – varje projekt speglar vår passion för skandinavisk design och hållbara lösningar.
          </p>
        </div>
      </section>
